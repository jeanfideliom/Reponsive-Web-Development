...
<html>
	...
	<body data-spy = "scroll" data-target = ".navbar">
		...
		<section id="home" style = "background: url(portbg.jpg); background-size: 100% 100%;" class = "cl_white text-center">
			<h1>My Portfolio</h1>
		...
		<section id="work" class="container">
			...
			<div class="text-center">
				<img src = "java.png" class="img-thumbnail">
				<img src = "python.png" class="img-thumbnail">
				<img src = "php.png" class="img-thumbnail">
				<img src = "bootstrap.png" class="img-thumbnail">
				<img src = "mysql.png" class="img-thumbnail">
				<img src = "csshtml.png" class="img-thumbnail">
			</div>
					...
					<div class="col-md-6">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<img src="ID PHOTO.jpg" class="img-circle center-block">
